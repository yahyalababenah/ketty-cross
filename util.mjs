// util.mjs
// ثوابت اللعبة والأدوات المساعدة — متوافق مع بقية الملفات (ESM)
...
// انحراف نموذج الروبوت: النموذج يبنى مواجها +X، ونريد الأمام +Z
...
// عشوائيات بسيطة مطلوبة لولادة المستوى والكائنات
export function pick(arr){ return arr[Math.floor(Math.random()*arr.length)]; }
export function rand(a,b){ return a + Math.random()*(b-a); }

// لاستبدال مولّد عشوائي لاحقًا إن رغبت
export function reseed(){ /* نستخدم Math.random الافتراضي حاليًا */ }
